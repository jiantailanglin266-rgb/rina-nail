...
| `{{INSTAGRAM_URL}}` | `NEXT_PUBLIC_INSTAGRAM_URL` | ヒーローのInstagram導線、ヘッダー／フッター／モバイルメニューのSNSアイコン、JSON-LD の `sameAs`、`llms.txt`                          | Instagram導線とアイコンが**非表示**になります                     |
| `{{LINE_URL}}`      | `NEXT_PUBLIC_LINE_URL`      | ヘッダー／フッター／モバイルメニューのSNSアイコン、JSON-LD の `sameAs`、`llms.txt`                                                   | LINEアイコンが**非表示**になります                                |
| `{{X_URL}}`         | `NEXT_PUBLIC_X_URL`         | ヘッダー／フッター／モバイルメニューのSNSアイコン、JSON-LD の `sameAs`、`llms.txt`                                                   | Xアイコンが**非表示**になります                                   |
| `{{TIKTOK_URL}}`    | `NEXT_PUBLIC_TIKTOK_URL`    | ヘッダー／フッター／モバイルメニューのSNSアイコン、JSON-LD の `sameAs`、`llms.txt`                                                   | TikTokアイコンが**非表示**になります                              |
| `{{YOUTUBE_URL}}`   | `NEXT_PUBLIC_YOUTUBE_URL`   | ヘッダー／フッター／モバイルメニューのSNSアイコン、JSON-LD の `sameAs`、`llms.txt`                                                   | YouTubeアイコンが**非表示**になります                             |
| `{{FACEBOOK_URL}}`  | `NEXT_PUBLIC_FACEBOOK_URL`  | ヘッダー／フッター／モバイルメニューのSNSアイコン、JSON-LD の `sameAs`、`llms.txt`                                                   | Facebookアイコンが**非表示**になります                            |
